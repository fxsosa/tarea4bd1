...
SELECT NROPRESTAMO, NROSOCIO, CI, NOMBRES, APELLIDOS, SP.APELLIDOS||''||SP.NOMBRES
FROM SOCIO, SOCIO SP
JOIN PRESTAMO
ON SOCIO.NROSOCIO = PRESTAMO.NROSOCIO
WHERE SOCIO.SOCIOPROPONENTE = NULL OR (SOCIO.SOCIOPROPONENTE = SP.NROSOCIO)
ORDER BY PRESTAMO.MONTO DESC;
