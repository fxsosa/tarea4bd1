...
INSERT INTO SOCIOS(NROSOCIO, NOMBRES, APELLIDOS, CI, EDAD, SOCIOPROPONENTE)
VALUES(SOCIOS_NROSOCIO_SEQ.nextval,'Laura','Diaz',33,3333,1);
...
CREATE OR REPLACE VIEW VISTA_SOCIOS(NROSOCIO, NOMBRES, APELLIDOS, CI, TOTAL_PRESTAMO_OBTENIDO, TOTAL_PRESTAMO_CANCELADO, SOCIOPROPONENTE) AS
       SELECT
              S1.NROSOCIO,
